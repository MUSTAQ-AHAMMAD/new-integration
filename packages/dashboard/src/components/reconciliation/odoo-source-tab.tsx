...
/**
 * Did the data we pulled out of Odoo land in our own tables intact? This is the
 * upstream half of reconciliation — it says nothing about Oracle, and a clean
 * result here is the precondition for trusting the Odoo ↔ Oracle comparison.
 */
export function OdooSourceTab() {
  const { data } = useQuery({
