...
export default function PushStorePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Push Single Store</h1>
        <p className="text-sm text-gray-500">Manually trigger a full order sync for a specific store branch</p>
      </div>
