  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Order Sync Manager</h1>
          <p className="text-sm text-gray-500">Search, filter, retry, and export order synchronization activity.</p>
        </div>
