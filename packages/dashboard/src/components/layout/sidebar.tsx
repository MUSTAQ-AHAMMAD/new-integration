...
const topItems: NavItem[] = [
  ...
  { href: '/region-status', label: 'Region Status', icon: Globe },
  ...
  { href: '/fetch-orders', label: 'Fetch Orders', icon: Download },
...
const operationalItems: NavItem[] = [
  ...
  { href: '/skipped-orders', label: 'Skipped Orders', icon: AlertTriangle },
...
const adminGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: Archive,
    items: [
      { href: '/admin/backup-vendhq', label: 'VendHQ Backup', icon: Archive },
      { href: '/admin/backup-odoo', label: 'Odoo Backup', icon: Archive },
      { href: '/admin/backup-ibq', label: 'IBQ Backup', icon: Archive },
